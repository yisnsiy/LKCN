...
class Config(object):
    ...
    def _build_path_config(self):
        ...
        model_config_file = os.path.join(dir, "model/{}.json".format(model_name))
        best_config_file = os.path.join(dir, "best_config/{}_{}.json".format(model_name, dataset_name))
        dataset_config_file = os.path.join(dir, "dataset/{}.json".format(dataset_name))
        ...
        path_config_dict["dataset_dir"] = "data"
        ...
        path_config_dict["log_file"] = 'logs/' + strtime + '{}-{}.log'.format(model_name, dataset_name)
        path_config_dict["output_dir"] = 'results/' + strtime + '{}-{}'.format(model_name,dataset_name)
