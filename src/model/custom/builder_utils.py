...
def get_layer_maps(genes, n_levels, direction, add_unk_genes, network_flag):
    if network_flag == 'reactome':
        ...
        reactome_layers = ProteinNetwork(genes).get_layers(n_levels, direction)
    elif network_flag == 'reactome_protein':
        reactome_layers = ReactomeProteinNetwork(genes).get_layers(n_levels, direction)
