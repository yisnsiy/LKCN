...
class Metrics:
    ...
    def evaluate_classification_binary(
        ...
        if model_name is not None:
            best_effect['model_name'] = model_name
        if max_f1 == False:
            th = 0.5
            y_pred = y_prob > th
            ...
            best_effect['accuracy'] = accuracy
            best_effect['precision'] = precision
            best_effect['f1'] = f1
            best_effect['recall'] = recall
        ...
        # model_name = 'Pathways based CINN + MASK'
