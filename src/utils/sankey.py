...
PATHWAY_PATH = join(os.getcwd(), 'data/pathways')
...
def run(result_path, number_layer=7):
    global RESULT_PATH, n_layer
    RESULT_PATH = result_path 
    n_layer = number_layer
    ...
    for x in node_importance.index:
        if x in name_to_id_dict.keys() and node_importance.loc[x]['layer'] != 1:
...
if __name__ == "__main__":
    run('./results/20231106-181601breast-network_reactome-layer_5-gcn_no-know_yes-cnt_2-breast', 5+2)
